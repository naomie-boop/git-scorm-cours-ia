document.addEventListener("DOMContentLoaded", function() {
  ...
  allSteps.forEach(function(step,idx){
    ...
    cta.innerHTML="<div class='next-teaser'>\u2705 Section termin\u00e9e</div><div class='next-title'>"+(teasers[idx+1]||"")+"</div><div class='next-preview'>"+(previews[idx+1]||"")+"</div><button class='step-next-btn' data-goto='"+(idx+1)+"'>Continuer <span class='arrow'>\u2192</span></button>";
